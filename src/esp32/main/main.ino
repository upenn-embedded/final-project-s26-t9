...
void
handle_move_data(const uint8_t *move_payload, uint8_t payload_len) {
    ...
    Serial.printf("[MAIN ESP32] MOVE_DATA broadcast — robot0 dir=%u dist=%u\n", (uint16_t) (move_payload[0] | (move_payload[1] << 8)), (uint16_t) (move_payload[2] | (move_payload[3] << 8)));
}